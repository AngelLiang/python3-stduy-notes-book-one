...
# 整型与字符串之间的转换
>>> bin(100)  # 十进制整型转二进制字符串
'0b1100100'
>>> oct(100)  # 十进制整型转八进制字符串
'0o144'
>>> hex(100)  # 十进制整型转十六进制字符串
'0x64'
>>> hex(0x64)  # 十六进制整型转十六进制字符串
'0x64'
>>> int('0b1100100', 2)  # 二进制字符串转十进制整型
100
>>> int('0o144', 8)  # 八进制字符串转十进制整型
100
>>> int('0x64', 16)  # 十六进制字符串转十进制整型
100
>>> int('64', 16)  # 省略进制前缀
100
>>> int(' 100 ')  # 忽略多余空白符
